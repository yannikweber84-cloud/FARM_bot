...
let existingMessage =
null;
// Erst nach einer angepinnten Regelwerk-Nachricht suchen.
// fetchPins() ersetzt das veraltete fetchPinned().
// Die Nachrichten liegen in pinnedResult.items[].message.
const pinnedResult =
...
error => {
console.error(
"❌ Gepinnte Nachrichten konnten nicht geladen werden:",
error
);
return null;
}
...
// Falls nicht angepinnt: letzte 100 Nachrichten prüfen.
if (!existingMessage) {
